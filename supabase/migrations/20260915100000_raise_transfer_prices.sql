-- Across-the-board tariff increase: every fare +€3, both vehicles.
-- Mirrors src/routes.js, which stays the source of truth;
-- scripts/verify-prices.mjs checks the two against each other.
