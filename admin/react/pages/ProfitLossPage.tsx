...
function ProfitMetrics({ metrics, period, navigate, onSaveDistance }: {
  ...
  return <>
    ...
    <p className="budget-footnote profit-footnote">İptal edilen ve henüz gerçekleşmemiş seferler hesaba katılmaz. Gidiş-dönüş fiyatı iki seyahat ayağına eşit bölünür. Havalimanından başlayan her seyahat için 5 € karşılama maliyeti eklenir. Transferlerde her yolculu mesafesine aynı uzunlukta boş dönüş eklenir. Günlük kiralamalarda gelir hizmet günlerine dağıtılır ve admin detayına girilen gerçek kilometre kullanılır; müşterinin ayrıca ödediği yakıt tutarı gelire eklenmez.</p>
  </>
}
