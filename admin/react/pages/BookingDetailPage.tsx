...
function BookingEditor({ booking, onCancel, onSaved }: { booking: Booking; onCancel: () => void; onSaved: (booking: Booking) => void }) {
  ...
  return <form noValidate onSubmit={submit}>
    ...
    <div className="booking-edit-group"><div className="section-label">Transfer</div>
      <Field label="Sefer türü"><select className="input" value={form.tripType} onChange={e => set('tripType', e.target.value)}><option value="one_way">Tek yön</option><option value="round_trip">Gidiş-dönüş</option><option value="daily_chauffeur">Günlük araç + şoför</option></select></Field>
