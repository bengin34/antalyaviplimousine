      ...
      /* @__PURE__ */ jsxs("form", { className: "booking-card", id: "quote-form", noValidate: true, onSubmit: handleSubmit(submit), children: [
        (isDailyChauffeur || step === 1) && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          !isDailyChauffeur && /* @__PURE__ */ jsxs("div", { className: "booking-row booking-hotel-row", children: [
            renderHotelField(),
            /* @__PURE__ */ jsx("p", { className: `hotel-region-hint${hotelMatch && hotelSetsDestination ? " is-matched" : ""}`, id: "hotel-region-hint", children: hotelMatch && hotelSetsDestination ? `${hotelMatch.name} — ${regionLabel(hotelMatch.region)}` : t("hotelSearchHint", "Type your hotel name and pick it from the list; we fill in the destination region and price for you.") })
          ] }),
