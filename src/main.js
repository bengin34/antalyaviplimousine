...
const translations = {
  ...
  ar: {
    ...
    campaignDiscount: "خصم 15٪",
    campaignScope: "على جميع أسعار النقل",
    campaignApplied: "تم تطبيق خصم الإنترنت 15٪",
    onlineDiscountShort: "خصم الإنترنت 15٪",
    discountPricesShown: "الأسعار المعروضة تشمل خصم الإنترنت 15٪",
