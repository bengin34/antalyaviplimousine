...
const privacyPath = { en: "/privacy/", de: "/de/datenschutz/", fr: "/fr/privacy/", tr: "/tr/gizlilik/", ru: "/ru/privacy/", cs: "/cs/privacy/" } as const;
const imprintPath = { en: "/impressum.html", de: "/de/impressum/", fr: "/fr/impressum/", tr: "/tr/kunye/", ru: "/ru/impressum/", cs: "/cs/impressum/" } as const;
const privacyLabel = { en: "Privacy", de: "Datenschutz", fr: "Confidentialité", tr: "Gizlilik", ru: "Конфиденциальность", cs: "Ochrana soukromí" } as const;
const imprintLabel = { en: "Imprint", de: "Impressum", fr: "Mentions légales", tr: "Künye", ru: "Правовая информация", cs: "Impressum" } as const;
const privacySettingsLabel = { en: "Open privacy settings", de: "Datenschutzeinstellungen öffnen", fr: "Ouvrir les paramètres de confidentialité", tr: "Gizlilik ayarlarını aç", ru: "Открыть настройки конфиденциальности", cs: "Otevřít nastavení soukromí" } as const;
